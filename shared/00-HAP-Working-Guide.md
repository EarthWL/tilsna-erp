...
| `8` | ว่าง (is empty) | ✅ `[V]` **ข้ามโมดูล** | HR (branch, ยิงจริง) + บัญชี (branch `ZZTEST-REV-001` 31 ส.ค. ยิงจริง) — **ยังไม่เคยพิสูจน์ใน `filters` ของ search/get_multiple** |
| `9` | เท่ากับ (=) | ✅ `[V]` | บัญชีใช้ 18 จุด (มากที่สุด) |
| `10` | ไม่เท่ากับ (≠) | ✅ `[V]` | **ตัวที่ก่อ D-19** · บัญชีใช้ 8 จุด · HR 5 จุด |
...
| **`2` `31` `40` `42`** | ❓ ไม่รู้ | 🟡 | บัญชีอย่างละ 1 จุด |
