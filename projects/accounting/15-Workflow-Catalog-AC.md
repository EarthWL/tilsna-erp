...
### WF-AC-25 ออกใบสำคัญตั้งหนี้จากใบตั้งหนี้ (งาน 3.5 ครึ่งหลัง) — **สร้างและ publish แล้ว** `6a970bc77dc381d682a550ba` ✅ 2 ก.ย. 2569 · **publishVersion 3** (v3 เพิ่มกันชนงวดปิด) · สายลูก `6a970c20500f6714e479dfe8` (publish v2)
...
| R11 | **เส้นทาง `110302` ภาษีซื้อรอเรียกคืน ยังไม่ได้ทดสอบ** | กลไกเดียวกับ `110301` ที่ผ่านแล้ว แต่ยังไม่มีเคสจริงยืนยัน |
