...
- `29-Payroll-Calc-Sheet-P5-7.md` — **กระดาษคำนวณเงินเดือน 3 เคส** ที่ใช้เป็นเกณฑ์ตรวจรับ WF-HR-08 · ทุกตัวเลขมี rowId ของตารางตั้งค่ากำกับ · 🔴 ส่วนภาษียังคำนวณไม่ได้ (ขาด input) และรอลายเซ็น
