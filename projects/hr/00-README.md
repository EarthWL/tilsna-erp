...
- `27-Demo-Seed-HR.md` — ชุดข้อมูลเสมือนจริงสำหรับนำเสนอ (224 แถว 19 ตาราง) + **rowId ทุกแถวสำหรับลบทีหลัง**
- `28-Demo-Views-Charts-HR.md` — ชั้นนำเสนอบนข้อมูลชุดนั้น: **15 view · 10 chart · แดชบอร์ด HR** + เส้นทางเดินสาธิต 10 หน้าจอ + รายการที่ยังต้องเปิดดูด้วยตา
