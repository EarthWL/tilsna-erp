...
### 🆕 P7-8 โมดูลฝึกอบรม (HR/P7-8-TRAINING — 6 ก.ย. 2569)

**กลุ่ม:** HR-05 Talent (`6a8ee66ce56d2e6eb7bd6cb9`)

#### `hr_course` — หลักสูตรฝึกอบรม · `6a9d67b41204328eb1ade840` · ไอคอน `sys_12_1_graduation_cap`

| ฟิลด์ | controlId | type |
|---|---|---|
| ชื่อหลักสูตร | `6a9d67b54720c515252abed1` | 2 Text (ชื่อ record) |
| รหัสหลักสูตร | `6a9d67d74a73a3142151a9a1` | 2 Text · required |
| หมวดหลักสูตร | `6a9d67d74a73a3142151a9a2` | 9 SingleSelect (6 ค่า) |
| ผู้จัดอบรม/สถาบัน | `6a9d67d74a73a3142151a9a3` | 2 Text |
| เป็นหลักสูตรภายใน | `6a9d67d74a73a3142151a9a4` | 36 Checkbox |
| จำนวนชั่วโมง | `6a9d67d74a73a3142151a9a5` | 6 Number (2) |
| ค่าใช้จ่ายต่อคน | `6a9d67d74a73a3142151a9a6` | 6 Number (2) |
| อายุใบรับรอง (เดือน) | `6a9d67d74a73a3142151a9a7` | 6 Number (0) |
| เนื้อหาหลักสูตรโดยย่อ | `6a9d67d74a73a3142151a9a8` | 2 Text multiline |
| เปิดใช้งาน | `6a9d67d74a73a3142151a9a9` | 36 Checkbox |

**option key ของ `หมวดหลักสูตร`** — 🔴 **ค่าเหล่านี้ agent ตั้งเอง ยังไม่ได้ให้ HR ยืนยัน** (ลงไว้ใน `23-Pending-Human-Review.md`)

| ค่า | key |
|---|---|
| ปฐมนิเทศพนักงานใหม่ | `1a7f0d01-0001-4001-8001-000000000001` |
| ความปลอดภัยและอาชีวอนามัย | `1a7f0d01-0002-4001-8001-000000000002` |
| ทักษะวิชาชีพเฉพาะทาง | `1a7f0d01-0003-4001-8001-000000000003` |
| ภาวะผู้นำและการบริหาร | `1a7f0d01-0004-4001-8001-000000000004` |
| กฎหมายและการกำกับดูแล | `1a7f0d01-0005-4001-8001-000000000005` |
| อื่น ๆ | `1a7f0d01-0006-4001-8001-000000000006` |

#### `hr_training` — การเข้าอบรม · `6a9d67bd4720c515252abedb` · ไอคอน `sys_certificate_object`

| ฟิลด์ | controlId | type | หมายเหตุ |
|---|---|---|---|
| รายการอบรม | `6a9d67bef363582dd37935be` | 2 Text | ชื่อ record |
| หลักสูตร | `6a9d67ed4a22ad87b727a83e` | 29 Relation → `hr_course` · required | |
| พนักงาน | `6a9d67ed4a22ad87b727a840` | 29 Relation → `hr_employee` · required | |
| วันที่กำหนดอบรม | `6a9d67ed4a22ad87b727a842` | 15 Date | `DD/MM/YYYY` |
| วันที่เข้าอบรมจริง | `6a9d67ed4a22ad87b727a843` | 15 Date | `DD/MM/YYYY` |
| สถานะการอบรม | `6a9d67ed4a22ad87b727a844` | 11 Dropdown | default `Planned` |
| คะแนนที่ได้ | `6a9d67ed4a22ad87b727a845` | 6 Number (2) | |
| ผ่านการอบรม | `6a9d67ed4a22ad87b727a846` | 36 Checkbox | |
| เลขที่ใบรับรอง | `6a9d67ed4a22ad87b727a847` | 2 Text | |
| ใบรับรองหมดอายุ | `6a9d67ed4a22ad87b727a848` | 15 Date | `DD/MM/YYYY` · 🔴 เป็น trigger ของ workflow เตือนต่ออายุในเฟสถัดไป |
| ไฟล์ใบรับรอง | `6a9d67ed4a22ad87b727a849` | 14 Attachment | |
| ค่าใช้จ่ายจริง | `6a9d67ed4a22ad87b727a84a` | 6 Number (2) | |
| หมายเหตุ | `6a9d67ed4a22ad87b727a84b` | 2 Text multiline | |

**option key ของ `สถานะการอบรม`** — 🟢 **ใช้ key เดียวกับ shared optionset `OS_HR_TRAINING_STATUS` `738a7d5c-1c93-4cd2-b79c-468d389949a9` ทุกตัว** (ยังเป็น inline อยู่ แต่เมื่อผูกเข้า optionset จริงผ่าน Browser ข้อมูลเดิมจะไม่หลุด)

| ค่า | key |
|---|---|
| Planned | `98455eb4-239e-44c8-baf1-b74ea266df03` |
| Enrolled | `55b6627f-81f9-4d27-bb35-88203a82d768` |
| Attended | `00d640f2-342e-4dec-9e37-c22fc142d73c` |
| Passed | `8c92f9b5-d4f9-40ac-9155-cb1b6261b51b` |
| Failed | `65921a32-b3e1-4328-bfd4-ff0af4d033ea` |
| Absent | `d4cc797d-d899-40df-823f-f76fd36fd1bd` |
| Cancelled | `98c157d1-3ddc-4ac8-ae1a-b406f7427833` |

#### View ของ `hr_training`

| viewId | viewType | ชื่อ | ตรวจแล้ว |
|---|---|---|---|
| `6a9d67bd4720c515252abedf` | 0 | All | — |
| `6a9d686f4a73a3142151a9c0` | 1 board | บอร์ดสถานะการอบรม | จัดกลุ่มด้วย `…a844` |
| `6a9d68711204328eb1ade862` | 0 sheet | แผนอบรมที่ยังไม่เกิดขึ้น | ✅ คืน **4 แถว** (Planned 3 + Enrolled 1) |
| `6a9d68724a22ad87b727a869` | 0 sheet | ใบรับรองที่มีวันหมดอายุ | ✅ คืน **1 แถว** = CRS-002 - EMP-0002 |
| `6a9d68741204328eb1ade864` | 4 calendar | ปฏิทินกำหนดอบรม | begindate = `…a842` |

#### ข้อมูล demo

**หลักสูตร 5 รายการ**

| รหัส | rowid | ชั่วโมง | ค่าใช้จ่าย/คน | อายุใบรับรอง |
|---|---|---|---|---|
| CRS-001 ปฐมนิเทศพนักงานใหม่ | `e9198a3f-d462-4f13-a224-df5b066863dc` | 6 | 0 (ภายใน) | — |
| CRS-002 ความปลอดภัยระดับหัวหน้างาน | `e220506f-a2e7-44fb-b050-d105838b7535` | 12 | 3,500 | 24 เดือน |
| CRS-003 ระบบ ERP สำหรับงานบัญชี | `6bee45ae-7a8d-4263-89a5-207050b82663` | 18 | 7,500 | — |
| CRS-004 ทักษะการเป็นหัวหน้างานยุคใหม่ | `e6767c5b-1af8-4f49-a86b-9ba31b5e7c0d` | 14 | 9,000 | — |
| CRS-005 PDPA สำหรับพนักงาน | `f581fbfd-aeda-4ee8-bdf9-5bcc9c527ed1` | 3 | 0 (ภายใน) | 12 เดือน |

**การเข้าอบรม 12 รายการ** ครอบคลุม 6 สถานะ — Passed 5 · Planned 3 · Enrolled 1 · Attended 1 · Failed 1 · Absent 1 · มีทั้งเคสสอบไม่ผ่าน (EMP-0004 ได้ 52) และเคสขาดอบรม (EMP-0006) เพื่อให้บอร์ดสถานะไม่ได้มีแต่สีเขียว

⬜ **ยังไม่ทำ:** IX-23.1 unique index (`หลักสูตร`, `พนักงาน`, `วันที่กำหนดอบรม`) — Browser เท่านั้น · ผูก `สถานะการอบรม` เข้า shared optionset จริง · workflow เตือนใบรับรองใกล้หมดอายุ (ใช้ `…a848` เป็น date-field trigger)

---

### 🆕 โปรไฟล์คอลัมน์ของ relation field ทั้งโมดูล HR (HR/RELATION-COLUMNS — 6 ก.ย. 2569)

**ปัญหาที่แก้:** relation field ที่ไม่ได้ตั้ง `showControls` จะแสดง 3 ฟิลด์แรกของตารางปลายทาง ⇒ แท็บ "ทะเบียนพนักงาน" ท้ายฟอร์มขึ้น `รหัสพนักงาน · คำนำหน้า · ชื่อ (ไทย)` เสียคอลัมน์ให้ "นาย/นางสาว" และไม่เห็นนามสกุล/ตำแหน่ง

**สิ่งที่ทำ:** ตั้ง `showControls` แบบ **โปรไฟล์ต่อตารางปลายทาง** ⇒ ตารางเดียวกันถูกอ้างจากที่ไหนก็แสดงคอลัมน์ชุดเดียวกัน · ครอบคลุม **relation field 115 จุด ใน 34 ตาราง** (แก้จริง 114 จุด · เดิมไม่ได้ตั้งเลย 64 จุด)

| ตารางปลายทาง | worksheetId | ถูกอ้างจาก | คอลัมน์ที่แสดง |
|---|---|---|---|
| ทะเบียนพนักงาน | `6a8efa5e9762533b5b7185c1` | 23 จุด | รหัสพนักงาน · ชื่อ (ไทย) · นามสกุล (ไทย) · ตำแหน่งงาน · สถานะพนักงาน |
| หน่วยงาน / ศูนย์ต้นทุน | `6a85452b9b6999a714d26720` | 6 จุด | รหัสหน่วยงาน · ชื่อหน่วยงาน (ไทย) · เปิดใช้งาน |
| ระดับพนักงาน | `6a8ef9909762533b5b71859a` | 6 จุด | รหัสระดับ · ชื่อระดับ · ลำดับระดับ · เงินเดือนขั้นต่ำ · เงินเดือนขั้นสูง |
| ตำแหน่งงาน | `6a8ef9901378964f99849a6d` | 6 จุด | รหัสตำแหน่ง · ชื่อตำแหน่ง (ไทย) · กลุ่มงาน · ระดับตำแหน่งเริ่มต้น |
| ใบลา | `6a8f2dbaae2a0e3743a0beaa` | 5 จุด | เลขที่ใบลา · พนักงาน · ประเภทการลา · วันที่เริ่มลา · จำนวนวันลา · สถานะใบลา |
| เหตุการณ์การจ้าง | `6a8efd1e8b6633ef76f12ad4` | 5 จุด | เลขที่เหตุการณ์ · พนักงาน · ประเภทเหตุการณ์ · วันที่มีผล |
| บันทึกลงเวลา | `6a8fcd67353e1b0e4a507d32` | 4 จุด | พนักงาน · วันที่ทำงาน · สถานะรายวัน · นาทีที่สาย · ชั่วโมงทำงานจริง |
| ผู้สมัคร | `6a95c137ae2a0e3743a1887f` | 4 จุด | ชื่อผู้สมัคร · ตำแหน่งที่สมัคร · ขั้นตอนการคัดเลือก · โทรศัพท์มือถือ |
| สลิปเงินเดือน | `6a904c85353e1b0e4a50ba05` | 4 จุด | เลขที่สลิปเงินเดือน · พนักงาน · งวดจ่าย · รวมรายรับ · เงินได้สุทธิ |
| สิทธิและยอดคงเหลือการลา | `6a8f2dba353e1b0e4a507757` | 3 จุด | พนักงาน · ประเภทการลา · ปีสิทธิ · สิทธิรวม · คงเหลือ |
| ประเภทการลา | `6a8eebf89762533b5b7184cf` | 3 จุด | รหัส · ชื่อประเภทการลา · ได้รับค่าจ้าง · เปิดใช้งาน |
| ใบขออัตรากำลัง | `6a95c1349762533b5b7250b5` | 3 จุด | เลขที่ใบขออัตรากำลัง · ตำแหน่งงาน · จำนวนอัตราที่ขอ · สถานะใบขอ |
| สวัสดิการ | `6a95c0db8b6633ef76f1fcf9` | 3 จุด | รหัสสวัสดิการ · ชื่อสวัสดิการ · วงเงินสิทธิ · วงเงินสูงสุดต่อครั้ง · เปิดใช้งาน |
| รายการเคลื่อนไหวสิทธิลา | `6a8f2dba9762533b5b718675` | 3 จุด | เลขที่รายการ · ประเภทรายการ · จำนวนวัน (+ เพิ่ม / − ลด) · วันที่มีผล · ยอดคงเหลือหลังรายการนี้ |
| แบบประเมินผล | `6a95c13d1378964f99857913` | 3 จุด | ชื่อแบบประเมิน · พนักงาน · สถานะการประเมิน · คะแนนสุดท้าย · เกรด |
| กะการทำงาน | `6a8eebf79762533b5b7184c5` | 2 จุด | รหัสกะ · ชื่อกะ · เวลาเข้างาน (HH:mm) · เวลาออกงาน (HH:mm) · ชั่วโมงทำงานมาตรฐาน |
| ผู้ติดตามและผู้ใช้สิทธิลดหย่อน | `6a8efd1eae2a0e3743a0bd93` | 2 จุด | ชื่อผู้ติดตาม · ความสัมพันธ์ · ใช้สิทธิลดหย่อน · ใช้สิทธิสวัสดิการ |
| บัญชีธนาคารพนักงาน | `6a8efd1fae2a0e3743a0bd9d` | 2 จุด | ชื่อบัญชี · ธนาคาร · เลขที่บัญชี · บัญชีหลัก |
| ใบขออนุมัติล่วงเวลา | `6a8fcca48b6633ef76f13033` | 2 จุด | เลขที่ใบขอ OT · พนักงาน · วันที่ทำ OT · จำนวนชั่วโมง OT · สถานะใบขอ OT |
| โครงสร้างเงินเดือน | `6a8ff287353e1b0e4a508550` | 2 จุด | พนักงาน · องค์ประกอบค่าจ้าง · จำนวนเงิน · มีผลตั้งแต่ · เปิดใช้งาน |
| หนังสือรับรองการหักภาษี ณ ที่จ่าย | `6a904e73353e1b0e4a50ba83` | 2 จุด | เลขที่หนังสือรับรอง · พนักงาน · ปีภาษี · รวมรายได้ · รวมภาษีหัก |
| วงเงินสวัสดิการคงเหลือ | `6a95c0de9762533b5b7250a1` | 2 จุด | พนักงาน · สวัสดิการ · ปีสิทธิประโยชน์ · วงเงินสิทธิ · วงเงินคงเหลือ |
| ผังบัญชี | `6a85516e1049edca1eecd9b7` | 2 จุด | รหัสบัญชี · ชื่อบัญชี (ไทย) · ประเภทบัญชี |
| รายการในสลิปเงินเดือน | `6a904c858b6633ef76f16a0b` | 2 จุด | ลำดับรายการ · รายละเอียดรายการ · องค์ประกอบค่าจ้าง · จำนวนเงิน |
| การยื่นภาษีเงินได้หัก ณ ที่จ่าย | `6a904e72ae2a0e3743a0fd06` | 2 จุด | ชื่อการยื่น · ประเภทแบบ · ปีภาษี · เดือนภาษี · รวมภาษีหัก · สถานะการยื่น |
| องค์ประกอบค่าจ้าง | `6a8ff2868b6633ef76f13871` | 2 จุด | รหัส · ชื่อองค์ประกอบ · ประเภท · วิธีคำนวณ · เปิดใช้งาน |
| งวดจ่ายเงินเดือน | `6a8ff2878b6633ef76f1387b` | 2 จุด | ชื่องวด · ปี · เดือน · สถานะงวด · รวมสุทธิ |
| นโยบายสิทธิการลา | `6a8eebf88b6633ef76f129e1` | 1 จุด | ชื่อนโยบาย · ประเภทการลา · อายุงานขั้นต่ำ (เดือน) · สิทธิการลา (วัน) |
| สัญญาจ้าง | `6a8efd1e9762533b5b718618` | 1 จุด | เลขที่สัญญา · พนักงาน · วันเริ่มสัญญา · วันสิ้นสุดสัญญา · สถานะสัญญา |
| งวดบัญชี | `6a8434d5055f2288c5b6d4b8` | 1 จุด | ชื่องวด · ปีบัญชี · งวดที่ · สถานะงวดบัญชี |
| ใบสำคัญ | `6a85fb2e9b6999a714d2a53d` | 1 จุด | คำอธิบายรายการ · วันที่ใบสำคัญ · ประเภทเอกสาร · (ระบบ) ผ่านรายการแล้ว |
| การสัมภาษณ์ | `6a95c1399762533b5b7250c1` | 1 จุด | ผู้สมัคร · รอบที่สัมภาษณ์ · วันเวลาสัมภาษณ์ · คะแนน · ผลการสัมภาษณ์ |
| รอบประเมินผล | `6a95c13b1378964f99857909` | 1 จุด | ชื่อรอบประเมิน · ปีที่ประเมิน · ครั้งที่ · (ระบบ) เปิดรอบแล้ว |
| รายการประเมิน | `6a95c140353e1b0e4a515ae6` | 1 จุด | ชื่อรายการประเมิน · หมวดรายการ · น้ำหนัก (%) · คะแนนตนเอง · คะแนนหัวหน้า |
| หลักสูตรฝึกอบรม | `6a9d67b41204328eb1ade840` | 1 จุด | รหัสหลักสูตร · ชื่อหลักสูตร · หมวดหลักสูตร · จำนวนชั่วโมง · ค่าใช้จ่ายต่อคน |
| รายการในใบเบิก | `6a9d19e24a22ad87b727a348` | 1 จุด | ลำดับที่ · รายการค่าใช้จ่าย · ประเภทค่าใช้จ่าย · จำนวนเงิน · เลขที่ใบเสร็จ |
| ใบเบิกสวัสดิการ | `6a9d19c34720c515252ab8b1` | 1 จุด | เลขที่ใบเบิก · พนักงาน · สวัสดิการ · วันที่เกิดค่าใช้จ่าย · สถานะใบเบิก |

**หลักการเลือกคอลัมน์:** `รหัส/เลขที่` → `ชื่อที่คนอ่านออก` → `ตัวจำแนก (ประเภท/สถานะ)` → `ตัวเลขที่ต้องเห็น` · เลี่ยงคำนำหน้า ธง `(ระบบ)` ฟิลด์ข้อความยาว และ relation ซ้อน relation

**ตรวจหลังยิง:** ✅ relation field 115/115 ตรงโปรไฟล์ · ✅ ทุกตารางจำนวนฟิลด์เท่าเดิม (ไม่มี field หายจากการเขียนทับ 34 ตาราง) · ✅ เปิดฟอร์ม `ระดับพนักงาน / L6` ดูด้วยตา แท็บทะเบียนพนักงานขึ้น `รหัสพนักงาน · ชื่อ (ไทย) …` — **คำนำหน้าหายไปแล้ว**

> ⚠️ 4 ตารางปลายทางเป็นของฝั่งบัญชี (หน่วยงาน · ผังบัญชี · งวดบัญชี · ใบสำคัญ) — **แก้เฉพาะ relation field ที่อยู่บนตาราง HR เท่านั้น ไม่ได้แตะตารางบัญชี**

---

### 🆕 เก็บงานหน้าตา 3 เรื่อง (HR/UI-POLISH — 6 ก.ย. 2569)

#### 1. ข้อความ placeholder ภาษาจีน — แก้ 13 ฟิลด์

การออดิตภาษาจีนรอบ 6 ก.ย. เช้าตรวจชื่อฟิลด์/ชื่อ view/รูปแบบวันที่ **แต่ไม่ได้ตรวจ `hint`** ⇒ ตารางที่สร้างใหม่หลังจากนั้นยังขึ้นจีนในช่องกรอก (เหตุผลเต็มใน `../../shared/00-HAP-Working-Guide.md` §18)

| ตาราง | ฟิลด์ | เดิม | เป็น |
|---|---|---|---|
| ใบเบิกสวัสดิการ | วันที่เกิดค่าใช้จ่าย · วันที่อนุมัติ | `请选择日期` | `เลือกวันที่` |
| ใบเบิกสวัสดิการ | วงเงินคงเหลือขณะยื่น | `请填写数值` | `ระบุจำนวนเงิน` |
| ใบเบิกสวัสดิการ | สถานะใบเบิก | `请选择` | `เลือกรายการ` |
| ใบเบิกสวัสดิการ | ผู้อนุมัติที่ระบบกำหนด | `请选择成员` | `เลือกผู้ใช้ในระบบ` |
| ใบเบิกสวัสดิการ | หลักฐานประกอบ | `添加附件` | `แนบไฟล์` |
| ใบเบิกสวัสดิการ | ธง `(ระบบ)` 3 ตัว | `请填写数值` | `""` (ไม่ต้องมี placeholder) |
| รายการในใบเบิก | ลำดับที่ · จำนวนเงิน | `请填写数值` | `ระบุลำดับ` · `ระบุจำนวนเงิน` |
| รายการในใบเบิก | ใบเสร็จแนบ | `添加附件` | `แนบไฟล์` |

✅ **กวาดใหม่ทั้งโมดูล: 41 ตาราง · 540 ฟิลด์ · เหลือภาษาจีน 0 จุด · ชื่อฟิลด์ที่ไม่มีอักษรไทย 0 จุด**

#### 2. ฟิลด์ที่ชื่อเป็น alias ดิบ — แก้ 2 จุด

`6a8ff3149762533b5b7193c9` (บน `hr_employee`) และ `6a8ff3149762533b5b7193cb` (บน `hr_pay_component`) ชื่อ `hr_salary_structure` โผล่เป็น label บนฟอร์ม → เปลี่ยนเป็น **โครงสร้างเงินเดือน** ทั้งคู่

#### 3. View sweep — จาก 29 ตารางที่มี view เดียว เหลือ 9

สร้าง view ใหม่ **29 อัน** และเปลี่ยนชื่อ view เริ่มต้นจาก `All` → `ทั้งหมด` อีก **4 ตาราง** (ที่ agent สร้างเองแล้วลืมตั้งชื่อไทย) ⇒ ทั้งโมดูลมี **view รวม 102 อัน**

| ตาราง | view ที่เพิ่ม |
|---|---|
| วันหยุดประจำปี | ปฏิทินวันหยุด (calendar) · วันหยุดแยกตามประเภท (board) |
| ประเภทการลา | ประเภทการลาที่เปิดใช้งาน |
| อัตราค่าล่วงเวลา | อัตรา OT แยกตามประเภทวัน (board) |
| นโยบายสิทธิการลา | นโยบายที่เปิดใช้งาน |
| ตำแหน่งงาน | ตำแหน่งงานแยกตามกลุ่มงาน (board) · ตำแหน่งที่ใช้งานอยู่ |
| เหตุการณ์การจ้าง | เหตุการณ์แยกตามประเภท (board) · ไทม์ไลน์เหตุการณ์การจ้าง (calendar) |
| ผู้ติดตามฯ | ผู้ติดตามแยกตามความสัมพันธ์ (board) · ผู้ใช้สิทธิลดหย่อนภาษี |
| บัญชีธนาคารพนักงาน | บัญชีแยกตามธนาคาร (board) |
| รายการเคลื่อนไหวสิทธิลา | รายการเคลื่อนไหวแยกตามประเภท (board) |
| องค์ประกอบค่าจ้าง | องค์ประกอบแยกตามประเภท (board) · องค์ประกอบที่เปิดใช้งาน |
| งวดจ่ายเงินเดือน | กระดานสถานะงวดจ่าย (board) · ปฏิทินวันจ่ายเงิน (calendar) |
| โครงสร้างเงินเดือน | โครงสร้างที่ใช้อยู่ |
| การยื่น ภ.ง.ด.1 | กระดานสถานะการยื่นแบบ (board) |
| หนังสือรับรองหักภาษี | หนังสือรับรองแยกตามสถานะ (board) |
| ใบขออัตรากำลัง | กระดานสถานะใบขออัตรากำลัง (board) · ปฏิทินวันที่ต้องการเริ่มงาน (calendar) |
| การสัมภาษณ์ | ผลการสัมภาษณ์ (board) |
| รายการประเมิน | รายการประเมินแยกตามหมวด (board) |
| หลักสูตรฝึกอบรม | หลักสูตรแยกตามหมวด (board) · หลักสูตรที่เปิดใช้งาน |
| สวัสดิการ | สวัสดิการแยกตามรอบสิทธิ (board) · สวัสดิการที่เปิดใช้งาน |
| รายการในใบเบิก | รายการแยกตามประเภทค่าใช้จ่าย (board) |

**9 ตารางที่ยังมี view เดียว — ตั้งใจไม่เพิ่ม** เพราะเป็นตารางตั้งค่า/ตารางอ้างอิงที่มี 1–8 แถวและไม่มีมิติที่แบ่งแล้วมีประโยชน์: การตั้งค่าโมดูลบุคคล · กะการทำงาน · อัตราประกันสังคม · ขั้นบันไดภาษี · ค่าลดหย่อนภาษี · กฎการอนุมัติ (ยังว่าง) · ระดับพนักงาน · รายการในสลิปเงินเดือน · รอบประเมินผล

**ตรวจหลังยิง:** ✅ view ที่มี filter ทั้ง 7 อันคืนแถวจริง และ **`ผู้ใช้สิทธิลดหย่อนภาษี` คืน 8 จาก 9** (สมชาย แก้วประเสริฐ ไม่ได้ใช้สิทธิ) ⇒ พิสูจน์ว่ากรองจริงไม่ใช่แสดงทุกแถว · ✅ เปิด kanban `ตำแหน่งงานแยกตามกลุ่มงาน` ดูด้วยตา — แตกเป็น 5 คอลัมน์ตามกลุ่มงาน การ์ดกระจายถูก

---

### 🆕 ไอคอนซ้ำ + D-64 คอลัมน์ relation ฝั่ง AC (HR/UI-POLISH รอบสอง — 7 ก.ย. 2569)

#### ไอคอนซ้ำ — agent-ac แจ้งไว้ 2 คู่ · ตรวจของจริงเจอ **4 คู่** แก้แล้วทั้งหมด

อ่านไอคอนจาก `hap app info` → `sections[].childSections[].items[].iconUrl` (⚠️ `worksheet info` **ไม่คืนไอคอน** — วิธีตรวจที่ผมใช้รอบแรกจึงให้ผลลวงว่า "ไม่ซ้ำ")

| ตารางที่เปลี่ยน | จาก (ซ้ำกับ) | เป็น |
|---|---|---|
| ใบเบิกสวัสดิการ | `sys_bill_finance` (ซ้ำ งวดจ่ายเงินเดือน) | `sys_18_4_clinic` |
| รายการในใบเบิก | `sys_bullet-list_office` (ซ้ำ รายการในสลิปเงินเดือน) | `sys_table` |
| การเข้าอบรม | `sys_certificate_object` (ซ้ำ หนังสือรับรองหักภาษี) | `sys_2_4_training` |
| วงเงินสวัสดิการคงเหลือ | `sys_wallet_finance` (ซ้ำ แดชบอร์ดเจ้าหนี้ ฝั่ง AC) | `sys_crypto-wallet_finance` |

**หลักที่ใช้:** ตารางที่มาทีหลังเป็นฝ่ายเปลี่ยน · ไอคอนใหม่ตรวจแล้วทั้ง HTTP 200 และยังไม่มีใครใช้ในแอป
**เหลือซ้ำ 1 คู่ ตั้งใจไม่แก้:** `sys_dashboard` ของ `แดชบอร์ดบัญชี` กับ `แดชบอร์ด HR` — เป็นแดชบอร์ดทั้งคู่ คนละโมดูล ซ้ำโดยตั้งใจ

✅ ตรวจหลังยิง: 123 รายการในแถบข้างทั้งแอป · ไอคอนซ้ำเหลือ 1 คู่ตามที่ตั้งใจ

#### D-64 — relation บนตาราง **ฝั่ง AC** ที่ชี้มาตาราง HR 10 ช่อง

agent-ac ส่ง D-64 มาให้ (`handoff/AC-SUBTABLE-COLUMNS.md`) เพราะอยู่นอกขอบเขตเขา · ตั้ง `showControls` ด้วย **โปรไฟล์ชุดเดียวกับที่ใช้ในโมดูล HR** ⇒ ทั้งแอปแสดงคอลัมน์ของตาราง HR เหมือนกันหมดไม่ว่าอ้างจากฝั่งไหน

| ตาราง AC | ช่อง | ปลายทาง |
|---|---|---|
| งวดบัญชี | งวดจ่ายเงินเดือน | `hr_pay_period` |
| หน่วยงาน / ศูนย์ต้นทุน | กฎการอนุมัติฯ · ทะเบียนพนักงาน · เหตุการณ์การจ้าง ×2 · สลิปเงินเดือน · ใบขออัตรากำลัง | 6 ช่อง |
| ผังบัญชี | องค์ประกอบค่าจ้าง · สวัสดิการ | 2 ช่อง |
| ใบสำคัญ | งวดจ่ายเงินเดือน | `hr_pay_period` |

พร้อมกันนั้น **แก้ชื่อฟิลด์ที่เป็น alias ดิบอีก 3 จุดบนตาราง AC** — `hr_pay_period` ×2 → `งวดจ่ายเงินเดือน` · `hr_pay_component` → `องค์ประกอบค่าจ้าง` (ชนิดเดียวกับ `hr_salary_structure` ที่แก้ไปรอบก่อน)

**เพิ่มโปรไฟล์ใหม่ 1 ตาราง** — `hr_approval_rule` `6a8eebf81378964f998499f8` → `ชื่อกฎ · ประเภทเอกสาร · ระดับการอนุมัติ · เปิดใช้งาน` (เดิมไม่มีเพราะไม่มี relation ฝั่ง HR ชี้มา)

✅ ตรวจหลังยิง: relation AC→HR **10/10 ตรงโปรไฟล์** · ชื่อที่เป็น alias ดิบเหลือ 0 · ทั้ง 4 ตาราง AC จำนวนฟิลด์เท่าเดิม (22 · 15 · 26 · 43)

> ⚠️ **แตะตาราง AC 4 ตาราง** (`งวดบัญชี` · `หน่วยงาน/ศูนย์ต้นทุน` · `ผังบัญชี` · `ใบสำคัญ`) ตามที่ agent-ac ส่ง D-64 มาให้ — **แก้เฉพาะ `showControls` และชื่อฟิลด์ 3 จุด ไม่ได้เพิ่ม/ลบฟิลด์ ไม่แตะข้อมูล**
