...
> **การใช้งาน:** เปิดไฟล์นี้คู่กับ `02-BuildSpec-FRS.md` และ `21-FRS-Modules-HR.md` (สเปกราย FR เดิม §2 — แยกออกมา 31 ส.ค. 2569) เสมอ — เนื้อหาที่นี่ **override** ค่า `<TBD>` ในแถว #20–22 ของ `02-BuildSpec-FRS.md` §1.3 และฟิลด์ทั้งหมดของ FR-HR-08 / FR-HR-09 ในไฟล์หลัก ส่วนที่เหลือยังใช้ได้ตามเดิมทั้งหมด — `02-BuildSpec-FRS.md` (§0, §1.1–1.2, §1.4–1.12, §4–§6) · `21-FRS-Modules-HR.md` (§2 ของ FR อื่น ๆ) · `22-Workflow-Catalog-HR.md` (§3) ไม่มีการเปลี่ยนแปลง
